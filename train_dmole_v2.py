"""Training entry point for the v2 cross-modal D-MoLE pipeline."""
...
def parse_args():
    """Parse CLI arguments for v2 training."""
...
def main():
    ...
    if args.report_to == "wandb":
        ...
        if ds.comm.get_rank() == 0:  # Only initialize wandb on the main process
            wandb.init(project="pixart-dreambooth-continual", name=f"train_v2_{timestamp}")
